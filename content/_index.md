...
### Happy Zoned (2024)
Mobile sleeping pods for budget stays in Dubai. Archived due to regional GCC zoning regulations, providing direct insight into how compliance impacts early-stage physical hardware.

### The Nature Hub
A fifteen-zone agri-leisure and education destination for a golf resort. Spatial layouts, revenue models, vendor databases, and event packages built for physical constraints without cloud dependencies.
...
### Open Destinations (2019 – 2020)
Engineering on Tineri, a mobile itinerary platform for tour operators built with Ionic 3 and Ruby on Rails.

### IFB Industries
An auto on/off microcontroller circuit for washing machines that eliminated display power draw when idle.
